...
using ManagementML.Model;

namespace ManagementML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Usama\Desktop\testing.tsv";
        private static string MODEL_FILEPATH = @"../../../../ManagementML.Model/MLModel.zip";
